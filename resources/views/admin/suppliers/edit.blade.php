        ...
        <form method="POST" action="{{ route("admin.suppliers.update", [$supplier->id]) }}"
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-md-6 col-sm-12">
                    <label class="required" for="supplier_name">{{ trans('cruds.supplier.fields.supplier_name')
                        }}</label>
                ...
                <div class="form-group col-lg-4 col-md-6 col-sm-12">
                    <label class="required" for="supplier_number">{{ trans('cruds.supplier.fields.supplier_number')
                        }}</label>
                    <input class="form-control {{ $errors->has('supplier_number') ? 'is-invalid' : '' }}" type="text"
                        name="supplier_number" id="supplier_number"
                        value="{{ old('supplier_number', $supplier->supplier_number) }}" required>
                ...
                <div class="form-group col-lg-4 col-md-6 col-sm-12">
                    ...
                    <input class="form-control {{ $errors->has('supplier_email') ? 'is-invalid' : '' }}" type="email"
